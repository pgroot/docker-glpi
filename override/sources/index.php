...
if (!file_exists(GLPI_CONFIG_DIR . "/config_db.php")) {
   ...
   echo '<head><title>'.$title_prefix.__('Authentication').'</title>'."\n";
   ...
   $login_logo = getenv("LOGIN_LOGO_URL") ?? $CFG_GLPI['root_doc']."/pics/login_logo_glpi.png";
   //end
   ...
   echo "<h1 id='logo_login'><img src='${login_logo}' alt='${title_prefix}' title='${title_prefix}' /></h1>";
